            ...
            >
              <div className="flex items-center gap-5">
                <div className="relative">
                  <img className="w-16 h-16 object-cover rounded-2xl shadow-sm ring-2 ring-white" src={photoUrl} alt="profile" />
                ...
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-slate-400 uppercase bg-slate-100 px-1.5 py-0.5 rounded">{gender[0]}</span>
                  </div>
                  <p className="text-sm text-slate-500 line-clamp-1 max-w-[250px]">{about || "Wants to connect with you"}</p>
                </div>
              </div>
