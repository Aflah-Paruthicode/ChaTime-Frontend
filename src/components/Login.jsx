    ...
    <div className="flex flex-col items-center justify-center text-slate-800">
      <div className="w-full min-w-80 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-10 border border-gray-100">
        <div className="flex flex-col items-center mb-10">
          <h1 className="text-2xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-slate-800 to-slate-500">Talksyo</h1>
        </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-500">
          New here?{" "}
          <Link to={"/signup"} className="text-purple-600 font-bold cursor-pointer hover:underline">
            Create account
          </Link>
        </p>
      </div>
